...
.'<span id="<<ID>>-name-'.$i.'" style="position: absolute;top: 20px; left: 3px;  display: block;z-index: 20;text-shadow: 0 3px 45px #bbf;font-size: 130pt;color: rgba(0,0,0,0);">'.encode_entities($c->{first}).'</span>'
        }
