...
.'<span id="<<ID>>-name-'.$i.'" style="position: absolute;top: 20px; left: 3px;  display: block;z-index: 20;text-shadow: 0 3px 45px #00f;font-size: 130pt;color: rgba(0,0,0,0);">'.$c->{lines}->[0].'___</span>'
        }
