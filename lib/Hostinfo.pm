...
sub init_flood {
    ...
    my $f = $self->{ground}->spawn_floozy($self, "flood",
        "width: 42%; min-width:509.188px; background: #337921; height: 100%; overflow: scroll;position: absolute; background-image: url(blue-velvet-sofa.jpg); right:0px;z-index:-1;"
    );
