...
<script src="jquery.min.js" type="text/javascript"></script>
    ...
    <div id='msgs' style="white-space: pre;position:absolute;font-size:60%;right:0em;bottom:0em;width:20%;height:20%; overflow:hidden;padding:0.2em;color:#abc;z-index:-200" onclick="keon();clon();" > </div>
